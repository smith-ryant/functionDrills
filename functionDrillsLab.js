...
let largenum = compareNums(212, 123) 
...
console.log(exclaimThree('the fox jumped the dog'));
////////////////// PROBLEM 9 ////////////////////
...
let nameGreeting = nameCheck('YourName');
console.log(nameCheck('Ryan'));
...
let colorRating = faveColorFinder('YourColor');
...
let oddChecker = thatsOdd(Number);
...
console.log(emailCheck('ryant.smith@outlook.com'));
////////////////// PROBLEM 19 ////////////////////
/*
...
const totalFrogs = buyChocolateFrogs(10);
...
var totalFrogs2 = buyChocolateFrogs2(4);
...
//CODE HERE
function isArrayInAscendingOrder(array) {
...
let arrayIsAscending = isArrayInAscendingOrder(sampleArray);
